				...
				<div class="content-perfil-empresa">
                    ...
                    <div class="row perfil-empresa-form">
                        ...
                        <div class="col-md-6 offset-md-3 col-lg-6offset-lg-3">
                            ...
                            <h4>@{{ title }}</h4>
                            <p>@{{ description }}</p>
                            <p><strong>Nombre de la empresa: </strong> @{{ businessName }}</p>
                            <p><strong>Dirección: </strong> @{{ region }}, @{{ commune }}</p>
        ...
        const devArea = new Vue({
            ...
            data() {
                return {
                    ...
                    region:"{{ $offer->user->region->name }}",
                    commune:"{{ $offer->user->commune->name }}",
                    proposal:"",
