                            ...
                            <nav class="menuppal">
                                ...
                                <!--opciones del menu responsive-->
                                    ...
                                    <ul class="menu-lateral-usuario_ul">
                                        ...
                                        <li class="menu-lateral-usuario_ul_li menu-resp-li" ><a href="{{ url('/profile/show/'.\Auth::user()->id) }}"> <img class="menu-lateral-usuario_ul_li_img" src="{{ asset('user/assets/img/ico-editar.png') }}" alt=""><p>Mi Curriculum</p></a></li>
                    ...
                    <div class="menu-lateral-usuario">
                        <div class="content-encontre-trabajo-caja-info">
                            ...
                            <ul class="menu-lateral-usuario_ul">
                                ...
                                <li class="menu-lateral-usuario_ul_li" ><a href="{{ url('/profile/show/'.\Auth::user()->id) }}"> <img class="menu-lateral-usuario_ul_li_img" src="{{ asset('user/assets/img/ico-editar.png') }}" alt=""><p>Mi Curriculum</p></a></li>
