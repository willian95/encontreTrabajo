...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Encontré Trabajo| Dashboard</title>
				...
				<div class="aside aside-left d-flex flex-column" id="kt_aside">
					...
					<div class="aside-nav d-flex flex-column align-items-center flex-column-fluid pt-7">
						...
						<ul class="nav flex-column">
							...
							<li class="nav-item mb-5" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Estadísticas">
								<a href="{{ url('/admin/statistics/index') }}" class="nav-link btn btn-icon btn-text-white btn-hover-text-white btn-lg">
