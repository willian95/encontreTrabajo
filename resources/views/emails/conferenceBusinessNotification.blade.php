                 ...
                 <tr style="border-collapse:collapse;"> 
                  <td width="540" align="center" valign="top" style="padding:0;Margin:0;"> 
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-position:left bottom;" role="presentation"> 
                     ...
                     <tr style="border-collapse:collapse;"> 
                      <td align="center" style="padding:0;Margin:0;"><h1 style="Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:bold;color:#0075A9;">¡Excelente, has creado una conferencia!</h1></td> 
                     </tr> 
                     <tr style="border-collapse:collapse;"> 
                      <td align="center" style="padding:0;Margin:0;padding-top:20px;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#34495e;">Usuario: {{ $username }}<br> Clave: {{ $password }}<br> Fecha: {{ $date_time }}<br> Eres el anfitrión de esta conferencia. Para ingresar solicitaremos primero la clave que aparece en este correo. Luego de introducir la contraseña solicitaremos el usuario y la clave que aparecen en este correo para iniciar la conferencia. Tu invitado estará en espera hasta que inicies la conferencia <br>Presiona el botón para ir a la conferencia </span><br></p></td> 
                     </tr> 
                     <tr style="border-collapse:collapse;"> 
                      <td align="center" style="padding:10px;Margin:0;"><span class="es-button-border es-button-border-2" style="border-style:solid;border-color:rgb(226, 206, 130);background:rgb(226, 206, 130);border-width:0px;display:inline-block;border-radius:0px;width:auto;"><a href="{{ $link }}" class="es-button es-button-1" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-size:16px;color:#FFFFFF;border-style:solid;border-color:#0c4572;border-width:10px 20px 10px 20px;display:inline-block;background:#0c4572;border-radius:0px;font-weight:normal;font-style:normal;line-height:19px;width:auto;text-align:center;">Ir a la conferencia</a></span></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
